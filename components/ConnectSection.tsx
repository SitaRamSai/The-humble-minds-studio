...
const socialLinks = [
  {
    ...
    description: 'Check out what we're building and working on.',
    icon: (
  ...
  },
  {
    ...
    description: 'Connect with us and follow along our journeys.',
    icon: (
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8 text-gray-400 transition-colors duration-300 group-hover:text-purple-300">
  ...
  },
   {
    ...
    description: 'Daily thoughts, questions, and learning updates.',
    icon: (
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8 text-gray-400 transition-colors duration-300 group-hover:text-purple-300">
...
const ConnectSection: React.FC = () => {
  return (
    <section id="connect">
      <h2 className="section-title text-2xl md:text-3xl font-semibold">Let's connect</h2>
      <p className="text-gray-400 text-sm md:text-base mb-6 leading-relaxed">
        Want to share what you're learning or just say hi? Find us on these platforms:
      </p>
        ...
        {socialLinks.map((link) => (
          ...
          >
            <div className="connect-card">
              ...
              <div>
                <h3 className="text-lg font-semibold text-purple-300">{link.name}</h3>
