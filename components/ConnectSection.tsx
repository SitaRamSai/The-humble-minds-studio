        ...
        {socialLinks.map((link) => (
          ...
          >
            <div className="connect-card">
              ...
              <div>
                <h3 className="text-lg font-semibold text-slate-900">{link.name}</h3>
                <p className="text-slate-500 text-sm opacity-80 group-hover:opacity-100 transition-opacity duration-300">{link.description}</p>
              </div>
            </div>
          </a>
        ))}
